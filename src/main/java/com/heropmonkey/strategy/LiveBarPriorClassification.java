package com.heropmonkey.strategy;

import com.heropmonkey.model.implementation.RandomForestImpl;
...
public class LiveBarPriorClassification {
    ...
    public String executeOrNot(){
        var ml = RandomForestImpl.getInstance();
        return ml.predict(open, high, low, close, wap, volume, count, minute, tesla3, tesla6, tesla9, decision);
    }
